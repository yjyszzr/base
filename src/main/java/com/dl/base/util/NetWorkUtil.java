...
public class NetWorkUtil {
	...
	public static String doPost(String url, Map<String, Object> params, String charset, int socketTimeoutMs,
			int connectTimeoutMs, boolean pretty) {
	...
	@SuppressWarnings("rawtypes")
	public static String doGet(String url, Map params, String charset, int socketTimeoutMs, int connectTimeoutMs,
			boolean pretty) throws HttpException, IOException {
		StringBuffer response = new StringBuffer();
		HttpClient client = new HttpClient();
		client.getHttpConnectionManager().getParams().setConnectionTimeout(connectTimeoutMs);
		client.getHttpConnectionManager().getParams().setSoTimeout(socketTimeoutMs);
		GetMethod method = new GetMethod(url);
		if (params.containsKey("Authorization") && StringUtils.isNotEmpty(params.get("Authorization").toString())) {
			method.addRequestHeader("Authorization", params.get("Authorization").toString());
		}
		method.getParams().setParameter(HttpMethodParams.RETRY_HANDLER, new DefaultHttpMethodRetryHandler(0, false));
		if (params != null) {
			NameValuePair[] data = null;
	...
	public static void doGetFile(String url, Map<Object, Object> params, String charset, int socketTimeoutMs,
			int connectTimeoutMs, String fileName) throws HttpException, IOException {
		HttpClient client = new HttpClient();
		client.getHttpConnectionManager().getParams().setConnectionTimeout(connectTimeoutMs);
		client.getHttpConnectionManager().getParams().setSoTimeout(socketTimeoutMs);
		GetMethod method = new GetMethod(url);
	...
	public static void doGet(String url, Map<Object, Object> params, String charset, String fileName)
			throws HttpException, IOException {
		doGetFile(url, params, charset, 10000, 10000, fileName);
	}

	public static String doGet(String url, Map<Object, Object> params, String charset, int socketTimeoutMs,
			int connectTimeoutMs) throws HttpException, IOException {
